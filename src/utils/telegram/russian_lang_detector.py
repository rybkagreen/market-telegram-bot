...
RUSSIAN_MARKERS = {
    ...
    "украина", "киев", "минск", "беларусь", "казахстан", "алматы",
    "русский", "русская", "русское", "русские",
    "новости", "бизнес", "маркетинг", "продажи", "инвестиции", "финансы",
    "канал", "телеграм", "telegram", "чат", "группа",
}
...
ENGLISH_MARKERS = {
    ...
    "all", "any", "some", "no", "not", "only", "own", "same",
    "can", "get", "make", "go", "know", "take", "see", "come",
...
ENGLISH_BLACKLIST = [
    ...
    "crypto signals", "crypto news", "crypto trading",
    "bitcoin signals", "bitcoin trading", "btc trading",
    "trading signals", "forex signals", "forex trading",
    "pump signals", "pump group", "binance signals",
    "nft drops", "nft collection", "nft mint",
    "defi yields", "yield farming", "staking rewards",
    "altcoins gems", "crypto gems", "100x gems",
    # Бизнес и финансы
    "business insider", "business news", "financial times",
    "wall street", "stock market", "stock trading",
    "investing.com", "bloomberg", "reuters",
    # Маркетинг и SMM
    "marketing pro", "digital marketing", "social media marketing",
    "smm tips", "smm tools", "smm services",
    "seo tips", "seo tools", "content marketing",
    # Технологии
    "tech crunch", "tech news", "tech daily",
    "ai news", "artificial intelligence", "machine learning",
    "startup news", "startup digest", "y combinator",
    # Новости
    "daily news", "world news", "breaking news",
    "news today", "news update", "news daily",
    "cnn", "bbc", "reuters", "associated press",
    # Развлечения
    "hollywood news", "celebrity news", "entertainment tonight",
    "music news", "movie trailers", "netflix series",
    # Спорт
    "espn", "sports news", "football news",
    "basketball news", "nba news", "premier league",
    # Путешествия
    "travel blog", "travel guide", "travel tips",
    "lonely planet", "tripadvisor", "booking.com",
    # Еда
    "food network", "food blog", "recipe blog",
    "tasty recipes", "buzzfeed food",
    # Мода и красота
    "vogue", "fashion week", "fashion blog",
    "beauty tips", "makeup tutorial", "skincare routine",
    # Образование
    "online courses", "coursera", "udemy",
    "learn english", "english course", "english lessons",
    "duolingo", "ted talks", "masterclass",
    # Недвижимость
    "real estate", "property for sale", "luxury homes",
    "zillow", "realtor.com", "property investment",
    # Автомобили
    "car news", "auto blog", "supercars",
    "tesla news", "electric vehicles", "car review",
    # Здоровье
    "health tips", "medical news", "wellness blog",
    "fitness tips", "gym workout", "healthline",
    # Наука
    "science daily", "nature journal", "science news",
    "scientific american", "new scientist",
    # Игры
    "gaming news", "pc gamer", "ign",
    "game reviews", "esports news", "twitch streamers",
    # Искусство
    "art news", "contemporary art", "art gallery",
    "photography blog", "photo daily", "artistic",
    # Политика
    "political news", "politics today", "government news",
    "election news", "capitol hill", "white house",
]
