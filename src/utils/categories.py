...
SUBCATEGORY_KEYWORDS: dict[str, list[str]] = {
    ...
    "real_estate": ["недвижимость", "квартира", "ипотека", "аренда", "жильё", "real estate", "apartment", "house", "mortgage", "rental"],
    # маркетинг
    ...
    # здоровье
    "fitness": ["фитнес", "спорт", "тренировки", "зал", "качалка", "воркаут", "fitness", "workout", "gym"],
    "nutrition": ["питание", "диета", "пп", "еда", "здоровое питание"],
    "mental_health": ["психология", "психотерапия", "ментальное здоровье", "стресс"],
    "medicine": ["медицина", "здоровье", "врач", "болезни", "лечение", "medicine", "doctor", "treatment", "disease", "health"],
}
