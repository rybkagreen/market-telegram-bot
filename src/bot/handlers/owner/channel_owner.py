...
async def show_channel_mediakit(callback: CallbackQuery) -> None:
    ...
    from src.bot.keyboards.owner.mediakit import get_mediakit_menu_kb
...
async def edit_mediakit(callback: CallbackQuery) -> None:
    ...
    from src.bot.keyboards.owner.mediakit import get_mediakit_edit_kb
...
async def edit_mediakit_color(callback: CallbackQuery) -> None:
    ...
    from src.bot.keyboards.owner.mediakit import get_color_selector_kb
