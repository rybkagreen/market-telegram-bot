...
from src.bot.keyboards.advertiser.campaign_ai import (
    CAMPAIGN_CATEGORIES,
    TEXT_STYLES,
    AIEditCB,
    AIVariantCB,
...
async def skip_image(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    from src.bot.keyboards.advertiser.campaign_ai import get_audience_keyboard
...
async def back_to_audience(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    from src.bot.keyboards.advertiser.campaign_ai import get_image_keyboard
...
async def process_budget(message: Message, state: FSMContext) -> None:
    ...
    from src.bot.keyboards.advertiser.campaign_ai import get_schedule_keyboard
...
async def cancel_ai_campaign(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    if user:
        from src.bot.keyboards.shared.main_menu import get_main_menu
