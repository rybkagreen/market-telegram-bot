...
def adv_menu_kb() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(text="📊 Статистика и аналитика", callback_data="main:analytics")
    )
    builder.row(
        InlineKeyboardButton(text="📣 Создать кампанию", callback_data="main:create_campaign")
    )
