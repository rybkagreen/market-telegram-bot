...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('total_spent', sa.Numeric(precision=12, scale=2), nullable=False, server_default='0.00'))
    op.add_column('users', sa.Column('total_earned', sa.Numeric(precision=12, scale=2), nullable=False, server_default='0.00'))
