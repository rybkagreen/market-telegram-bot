...
def upgrade() -> None:
    ...
    op.add_column(
        "users", sa.Column("login_streak_days", sa.Integer(), nullable=False, server_default="0")
    )
    op.add_column(
        "users", sa.Column("max_streak_days", sa.Integer(), nullable=False, server_default="0")
    )
