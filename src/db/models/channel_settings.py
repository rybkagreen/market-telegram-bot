...
class ChannelSettings(Base):
    ...
    channel_id: Mapped[int] = mapped_column(Integer, ForeignKey("telegram_chats.id"), primary_key=True)
    price_per_post: Mapped[Decimal] = mapped_column(Numeric(10, 2), default=Decimal("1000"), server_default="1000")
    allow_format_post_24h: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    allow_format_post_48h: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    allow_format_post_7d: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    allow_format_pin_24h: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    allow_format_pin_48h: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    ...
    def __repr__(self) -> str:
        return f"<ChannelSettings(channel_id={self.channel_id}, price_per_post={self.price_per_post})>"
