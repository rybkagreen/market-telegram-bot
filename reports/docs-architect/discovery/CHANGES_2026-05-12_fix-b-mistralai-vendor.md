...
- **SHA256:** `44ad3c52f45d43ce4af23faf397d39ef51c0ba8f3deafbbc4b16145aa5360890`
- **Wheel tag:** `py3-none-any` (universal pure Python, no compiled extensions)
- **NB:** SHA256 differs от original PyPI wheel (`44ad3c52f45d43ce4af23faf397d39ef51c0ba8f3deafbbc4b16145aa5360890`) — fresh local build от same source. Functionally identical; hash differs due к pip metadata + build timestamp embedded в wheel.
